#!/usr/bin/env bun
// User prompt submit hook - retrieves relevant docs and injects into context

import type { RetrieveResponse, IndexResponse } from "../../src/types";
...
function formatSnippets(results: RetrieveResponse["results"]): string {
